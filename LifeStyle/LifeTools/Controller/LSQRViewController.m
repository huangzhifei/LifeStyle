...
@implementation LSQRViewController
...
//    [self.view addSubview:btn1];
    ...
    UIImage *code = [UIImage imageNamed:@"me"];
    
    UIImageView *view = [[UIImageView alloc] initWithFrame:CGRectMake( (CGRectGetWidth(self.view.frame)-CGRectGetWidth(self.view.frame)*5/6)/2,
                                                                      100, CGRectGetWidth(self.view.frame)*5/6,
